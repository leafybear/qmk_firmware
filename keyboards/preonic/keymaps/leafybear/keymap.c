...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_preonic_1x2uC(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_GESC, MO(_LOWER), KC_SPC, MO(_RAISE), KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [_COLEMAK_DH] = LAYOUT_preonic_1x2uC(
    ...
    _______, _______, _______, _______, MO(_ADJUST), KC_MPLY, KC_TRNS, KC_BSLS, _______, KC_VOLD, _______
  ),
    ...
    KC_P1, KC_P3, KC_P7, _______, KC_TRNS, KC_MPLY, MO(_ADJUST), _______, _______, _______, _______
  ),
    ...
    RGB_M_SW, AU_ON, AU_OFF, _______, KC_TRNS, _______, KC_TRNS, _______, _______, _______, _______)
};
